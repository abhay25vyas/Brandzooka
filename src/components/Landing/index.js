                    ...
                    <div className="magic-connected-card-inner"> <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="magic-connected-card-text">
                                ...
                                <p>Brandzooka’s machine learning media trading algorightms routinely outperform their human counterparts 3:1. In every category - from auto to spirits, and from sports to consumer goods, Brandzooka advertisers get results. </p>
